...
export const stateList = [
  {
    id: "AL",
    name: "Alabama",
    component: () => <Alabama key={"state-AL"} />,
  },
  ...
  { id: "AZ", name: "Arizona", component: () => <Arizona key={"state-AZ"} /> },
  {
    id: "AR",
    name: "Arkansas",
    component: () => <Arkansas key={"state-AR"} />,
  },
  {
    id: "CA",
    name: "California",
  ...
  },
  {
    id: "CO",
    name: "Colorado",
    component: () => <Colorado key={"state-CO"} />,
  },
  {
    id: "CT",
    name: "Connecticut",
  ...
  },
  {
    id: "DE",
    name: "Delaware",
    component: () => <Delaware key={"state-DE"} />,
  },
  ...
  { id: "ID", name: "Idaho", component: () => <Idaho key={"state-ID"} /> },
  {
    id: "IL",
    name: "Illinois",
    component: () => <Illinois key={"state-IL"} />,
  },
  ...
  { id: "KS", name: "Kansas", component: () => <Kansas key={"state-KS"} /> },
  {
    id: "KY",
    name: "Kentucky",
    component: () => <Kentucky key={"state-KY"} />,
  },
  {
    id: "LA",
    name: "Louisiana",
    component: () => <Louisiana key={"state-LA"} />,
  },
  { id: "ME", name: "Maine", component: () => <Maine key={"state-ME"} /> },
  {
    id: "MD",
    name: "Maryland",
    component: () => <Maryland key={"state-MD"} />,
  },
  {
    id: "MA",
    name: "Massachusetts",
  ...
  },
  {
    id: "MI",
    name: "Michigan",
    component: () => <Michigan key={"state-MI"} />,
  },
  {
    id: "MN",
    name: "Minnesota",
    component: () => <Minnesota key={"state-MN"} />,
  },
  {
    id: "MS",
    name: "Mississippi",
  ...
  },
  {
    id: "MO",
    name: "Missouri",
    component: () => <Missouri key={"state-MO"} />,
  },
  { id: "MT", name: "Montana", component: () => <Montana key={"state-MT"} /> },
  {
    id: "NE",
    name: "Nebraska",
    component: () => <Nebraska key={"state-NE"} />,
  },
  { id: "NV", name: "Nevada", component: () => <Nevada key={"state-NV"} /> },
  {
    id: "NH",
    name: "New Hampshire",
  ...
  },
  {
    id: "NJ",
    name: "New Jersey",
    component: () => <NewJersey key={"state-NJ"} />,
  },
  {
    id: "NM",
    name: "New Mexico",
    component: () => <NewMexico key={"state-NM"} />,
  },
  { id: "NY", name: "New York", component: () => <NewYork key={"state-NY"} /> },
  {
    id: "NC",
    name: "North Carolina",
  ...
  { id: "OH", name: "Ohio", component: () => <Ohio key={"state-OH"} /> },
  {
    id: "OK",
    name: "Oklahoma",
    component: () => <Oklahoma key={"state-OK"} />,
  },
  ...
  },
  {
    id: "TN",
    name: "Tennessee",
    component: () => <Tennessee key={"state-TN"} />,
  },
  ...
  { id: "VA", name: "Virginia", component: () => <Virgina key={"state-VA"} /> },
  {
    id: "WA",
    name: "Washington",
    component: () => <Washington key={"state-WA"} />,
  },
  {
    id: "WV",
    name: "West Virginia",
  ...
  },
  {
    id: "WI",
    name: "Wisconsin",
    component: () => <Wisconsin key={"state-WI"} />,
  },
