              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <thead>
                  <tr className="align-top">
                    ...
                    <th
                      scope="col"
                      className="px-4 py-4 text-sm font-normal text-gray-500"
                    >
                      <button className="flex items-baseline gap-x-2 text-left">
                        <span>Chamber</span>
                    ...
                    <th
                      ...
                      className="px-4 py-4 text-sm font-normal text-gray-500"
                    >
                      <button className="flex gap-x-2 items-baseline text-left">
